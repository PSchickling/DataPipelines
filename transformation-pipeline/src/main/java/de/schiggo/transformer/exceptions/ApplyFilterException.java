 ...
 */
public class ApplyFilterException extends RuntimeException {
    ...
    public ApplyFilterException(Throwable e) {
        super(e);
    }

    public ApplyFilterException(String message, Throwable e) {
        super(message, e);
    }
}
